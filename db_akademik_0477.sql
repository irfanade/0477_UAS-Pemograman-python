...
--
-- Table structure for table `tbl_students_0477`
--

CREATE TABLE `tbl_students_0477` (
  `id` int(2) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0477`
--

INSERT INTO `tbl_students_0477` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
